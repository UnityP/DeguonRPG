...
namespace DungeonRPG.RoguelikeGeneratorPro
{
     public class RoguelikeGeneratorPro : MonoBehaviour
    {
        ...
        public EPatternType patternFloor = EPatternType.checker;
        ...
        public void InstanciateFloorOverlay()
        {
            for (int x = 0; x < levelSize.x - 1; x++)
            {
                for (int y = 0; y < levelSize.y - 1; y++)
                {
                    if (patternFloor == EPatternType.perlinNoise && IsFloorTouchingWall(x,y)) CreatePerlinFloor(x, y);
                    else if (patternFloor == EPatternType.checker && IsFloorTouchingWall(x, y)) CreateCheckerFloor(x, y);
                    else if (patternFloor == EPatternType.wideChecker && IsFloorTouchingWall(x, y)) CreateWideCheckerFloor(x, y);
                    else if (patternFloor == EPatternType.lineLeft && IsFloorTouchingWall(x, y)) CreateLineLeftFloor(x, y);
                    else if (patternFloor == EPatternType.lineRight && IsFloorTouchingWall(x, y)) CreateLineRightFloor(x, y);
                }
            }
        }
        ...
        public void CreatePerlinFloor(int _posX, int _posY)
        {
            ...
            if (value > noiseCutoffFloor) overlayTiles[_posX, _posY] = EOverlayType.floorPattern;
            else if (drawFloorOverlayRandomTiles && Random.Range(0, 100) < randomFloorOverlayChance) overlayTiles[_posX, _posY] = EOverlayType.floorRandom;
        }
        ...
        public void CreatePerlinWall(int _posX, int _posY)
        {
            ...
            if (value > noiseCutoffWall && drawWallOverlayPatternTiles) overlayTiles[_posX, _posY] = EOverlayType.wallPattern;
        ...
        public void CreateCheckerFloor(int _posX, int _posY)
        {
            ...
            if (value > noiseCutoffFloor && (_posX + _posY) % 2 == 0) overlayTiles[_posX, _posY] = EOverlayType.floorPattern;
            else if (drawFloorOverlayRandomTiles && Random.Range(0, 100) < randomFloorOverlayChance) overlayTiles[_posX, _posY] = EOverlayType.floorRandom;
        }
        ...
        public void CreateCheckerWall(int _posX, int _posY)
        {
            ...
            if (value > noiseCutoffWall && drawWallOverlayPatternTiles && (_posX + _posY) % 2 == 0) overlayTiles[_posX, _posY] = EOverlayType.wallPattern;
            else if (drawWallOverlayRandomTiles && Random.Range(0, 100) < randomWallOverlayChance) overlayTiles[_posX, _posY] = EOverlayType.wallRandom;
        }
        ...
        public void CreateWideCheckerFloor(int _posX, int _posY)
        {
            ...
            if (value > noiseCutoffFloor && (_posX + _posY) % 4 == 0 && _posX % 2 == 0 && _posY % 2 == 0) overlayTiles[_posX, _posY] = EOverlayType.floorPattern;
            else if (drawFloorOverlayRandomTiles && Random.Range(0, 100) < randomFloorOverlayChance) overlayTiles[_posX, _posY] = EOverlayType.floorRandom;
        }
        ...
        public void CreateWideCheckerWall(int _posX, int _posY)
        {
            ...
            if (value > noiseCutoffWall && drawWallOverlayPatternTiles && (_posX + _posY) % 4 == 0 && _posX % 2 == 0 && _posY % 2 == 0) overlayTiles[_posX, _posY] = EOverlayType.wallPattern;
            else if (drawWallOverlayRandomTiles && Random.Range(0, 100) < randomWallOverlayChance) overlayTiles[_posX, _posY] = EOverlayType.wallRandom;
        }
        ...
        public void CreateLineLeftFloor(int _posX, int _posY)
        {
            ...
            if (value > noiseCutoffFloor && (-_posX + _posY) % 3 == 0) overlayTiles[_posX, _posY] = EOverlayType.floorPattern;
            else if (drawFloorOverlayRandomTiles && Random.Range(0, 100) < randomFloorOverlayChance) overlayTiles[_posX, _posY] = EOverlayType.floorRandom;
        }
        ...
        private void Spawn()
        {
            if (generation == EGenType.generateTile)
            {
                ...
                for (int y = 0; y < levelSize.y; y++)
                {
                    ...
                    else if (tiles[x, y] == ETileType.wall)
                    {
                        ...
                        if (floorTop && !floorLeft && !floorBottom && !floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_2);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_2);
                        }
                        else if (!floorTop && floorLeft && !floorBottom && !floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_3);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_3);
                        }
                        else if (!floorTop && !floorLeft && floorBottom && !floorRight)
                        {
                            if (drawCorners)
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_4);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_4);
                        }
                        else if (!floorTop && !floorLeft && !floorBottom && floorRight)
                        {
                            if (drawCorners)
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_5);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_5);
                        }
                        ...
                        else if (floorTop && floorLeft && !floorBottom && !floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_6);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_6);
                        }
                        else if (!floorTop && floorLeft && floorBottom && !floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_7);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_7);
                        }
                        else if (!floorTop && !floorLeft && floorBottom && floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_8);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_8);
                        }
                        else if (floorTop && !floorLeft && !floorBottom && floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_9);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_9);
                        }
                        else if (!floorTop && floorLeft && !floorBottom && floorRight)
                        {
                            wallMap.SetTile(new Vector3Int(x, y, 0), wallTile_10);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_10);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_10);
                        }
                        else if (floorTop && !floorLeft && floorBottom && !floorRight)
                        {
                            wallMap.SetTile(new Vector3Int(x, y, 0), wallTile_11);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_11);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_11);
                        }
                        ...
                        else if (floorTop && floorLeft && !floorBottom && floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_12);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_12);
                        }
                        else if (floorTop && floorLeft && floorBottom && !floorRight)
                        {
                            wallMap.SetTile(new Vector3Int(x, y, 0), wallTile_13);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_13);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_13);
                        }
                        else if (!floorTop && floorLeft && floorBottom && floorRight)
                        {
                            wallMap.SetTile(new Vector3Int(x, y, 0), wallTile_14);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_14);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_14);
                        }
                        else if (floorTop && !floorLeft && floorBottom && floorRight)
                        {
                            wallMap.SetTile(new Vector3Int(x, y, 0), wallTile_15);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_15);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_15);
                        }
        ...
        private void SpawnGridTiles()
        {
            ...
            for (int x = 0; x < levelSize.x; x++)
            {
                for (int y = 0; y < levelSize.y; y++)
                {
                    ...
                    else if (overlayTiles[x, y] == EOverlayType.wallPattern) overlayMap.SetTile(new Vector3Int(x, y, 0), patternWallTile_1);
                    else if (overlayTiles[x, y] == EOverlayType.wallRandom) overlayMap.SetTile(new Vector3Int(x, y, 0), randomWallTile_1);
                }
            }
        }
            ...
            for (int x = 0; x < levelSize.x; x++)
            {
                for (int y = 0; y < levelSize.y; y++)
                {
                    if (tiles[x, y] == ETileType.floor)
                    {
                        ...
                        if (!wallTop && !wallLeft && !wallBottom && !wallRight)
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom))
                            {
                                if (drawCorners)
                                {
                                    //one side
                            ...
                            else if (overlayTiles[x, y] == EOverlayType.floorRandom) SpawnTile(randomFloorTileObj, overlayParent.transform, x, y);
                        }
                        ...
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom)) SpawnTile(floorTileObj_10, floorParent.transform, x, y);
                        ...
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom)) SpawnTile(floorTileObj_11, floorParent.transform, x, y);
                        ...
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom)) SpawnTile(floorTileObj_12, floorParent.transform, x, y);
                        ...
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom)) SpawnTile(floorTileObj_13, floorParent.transform, x, y);
                        ...
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom)) SpawnTile(floorTileObj_14, floorParent.transform, x, y);
                        ...
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom)) SpawnTile(floorTileObj_15, floorParent.transform, x, y);
                    ...
                    else if (tiles[x, y] == ETileType.wall)
                    {
                        ...
                        if (floorTop && !floorLeft && !floorBottom && !floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_2, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_2, overlayParent.transform, x, y);
                        }
                        else if (!floorTop && floorLeft && !floorBottom && !floorRight)
                        {
                            if (drawCorners)
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_3, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_3, overlayParent.transform, x, y);
                        }
                        else if (!floorTop && !floorLeft && floorBottom && !floorRight)
                        {
                            if (drawCorners)
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_4, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_4, overlayParent.transform, x, y);
                        }
                        else if (!floorTop && !floorLeft && !floorBottom && floorRight)
                        {
                            if (drawCorners)
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_5, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_5, overlayParent.transform, x, y);
                        }
                        ...
                        else if (floorTop && floorLeft && !floorBottom && !floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_6, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_6, overlayParent.transform, x, y);
                        }
                        else if (!floorTop && floorLeft && floorBottom && !floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_7, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_7, overlayParent.transform, x, y);
                        }
                        else if (!floorTop && !floorLeft && floorBottom && floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_8, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_8, overlayParent.transform, x, y);
                        }
                        else if (floorTop && !floorLeft && !floorBottom && floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_9, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_9, overlayParent.transform, x, y);
                        }
                        else if (!floorTop && floorLeft && !floorBottom && floorRight)
                        {
                            SpawnTile(wallTileObj_10, wallParent.transform, x, y);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_10, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_10, overlayParent.transform, x, y);
                        }
                        else if (floorTop && !floorLeft && floorBottom && !floorRight)
                        {
                            SpawnTile(wallTileObj_11, wallParent.transform, x, y);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_11, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_11, overlayParent.transform, x, y);
                        }
                        ...
                        else if (floorTop && floorLeft && !floorBottom && floorRight)
                        {
                            ...
                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_12, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_12, overlayParent.transform, x, y);
                        }
                        else if (floorTop && floorLeft && floorBottom && !floorRight)
                        {
                            SpawnTile(wallTileObj_13, wallParent.transform, x, y);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_13, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_13, overlayParent.transform, x, y);
                        }
                        else if (!floorTop && floorLeft && floorBottom && floorRight)
                        {
                            SpawnTile(wallTileObj_14, wallParent.transform, x, y);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_14, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_14, overlayParent.transform, x, y);
                        }
                        else if (floorTop && !floorLeft && floorBottom && floorRight)
                        {
                            SpawnTile(wallTileObj_15, wallParent.transform, x, y);

                            if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_15, overlayParent.transform, x, y);
                            else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_15, overlayParent.transform, x, y);
                        }
            ...
            for (int x = 0; x < levelSize.x; x++)
            {
                for (int y = 0; y < levelSize.y; y++)
                {
                    if (tiles[x, y] == ETileType.floor)
                    {
                        ...
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom)) SpawnTileRotated(floorTileObj_10, floorParent.transform, -90f, x, y);
                        ...
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom)) SpawnTileRotated(floorTileObj_12, floorParent.transform, -90f, x, y);
                        ...
                        {
                            if (!deleteFloorBelowOverlay || (deleteFloorBelowOverlay && overlayTiles[x, y] != EOverlayType.floorPattern && overlayTiles[x, y] != EOverlayType.floorRandom)) SpawnTileRotated(floorTileObj_12, floorParent.transform, 180f, x, y);
        ...
        private void SpawnTiles()
        {
            for (int x = 0; x < levelSize.x; x++)
            {
                for (int y = 0; y < levelSize.y; y++)
                {
                    ...
                    else if (overlayTiles[x, y] == EOverlayType.wallPattern) SpawnTile(patternWallTileObj_1, overlayParent.transform, x, y);
                    else if (overlayTiles[x, y] == EOverlayType.wallRandom) SpawnTile(randomWallTileObj_1, overlayParent.transform, x, y);
                }
            }
        }
