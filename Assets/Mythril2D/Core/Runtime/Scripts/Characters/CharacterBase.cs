...
namespace Gyvr.Mythril2D
{
    ...
    public abstract class CharacterBase : MonoBehaviour
    {
        ...
        public UnityEvent statsChanged => m_stats.changed;
        ...
        {
            // Whenever max stats change, we update current stats to match these new stats
            // Ex: if a character has 1HP and just leveled up, he will recover his full HP
            m_currentStats.Set(m_stats.stats);
        }

        private void OnCurrentStatsChanged()
        {
